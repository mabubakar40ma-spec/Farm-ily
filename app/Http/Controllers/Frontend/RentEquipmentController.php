...
use App\DataTables\AgentEquipmentRentBookingDataTable;
use App\DataTables\AgentRentEquipmentDataTable;
use App\Http\Controllers\Controller;
use App\Http\Requests\Frontend\RentEquipmentStoreRequest;
use App\Http\Requests\Frontend\RentEquipmentUpdateRequest;
...
class RentEquipmentController extends Controller
{
     ...
     */
    public function index(AgentRentEquipmentDataTable $dataTable): View | JsonResponse
    {
        return $dataTable->render('frontend.dashboard.rent-equipment.index');
    }
    ...
    public function create(): View
    {
        ...
        return view('frontend.dashboard.rent-equipment.create', compact('locations'));
    }
    ...
    public function store(RentEquipmentStoreRequest $request)
    {
        ...
        // dd($equipment->save());
        return redirect()->route('user.rent-equipment.index');
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.dashboard.rent-equipment.edit', compact('equipment', 'locations'));
    }
    ...
    public function RentEquipmentBooking(AgentEquipmentRentBookingDataTable $dataTable): View | JsonResponse
    {
        return $dataTable->render('frontend.dashboard.rent-equipment.rent-equipment-booking');
    }
}