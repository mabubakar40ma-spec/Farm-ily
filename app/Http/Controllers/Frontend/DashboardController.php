...
class DashboardController extends Controller
{
    ...
    //     return view('frontend.dashboard.dashboard.dashboard');
    // }
    function index(): View
    {
        ...
        return view('frontend.dashboard.dashboard.dashboard', compact('subscription', 'listingCount', 'pendingListingCount',  'activeListingCount'));
    }
}