                            ...
                            <form action="{{ route('user.listing-image-gallery.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    @if ($subscription->package->num_of_photos === -1)
                                        <label class="mb-2" for="">Image <code> ( Unlimited )(Multi image
                                                supported)</code></label>
                                    @else
                                        <label class="mb-2" for="">Image <code> (
                                                {{ $subscription->package->num_of_photos }} Images is max )(Multi image
                                                supported)</code></label>
                                    @endif
                                ...
                                <div class="form-group">
                                    <button type="submit" class="read_btn submit-button mt-4">Upload</button>
                                </div>
                            </form>
                        </div>
