                ...
                <div class="col-lg-12">
                    <div class="dashboard_content">
                        <div class="my_listing">
                            <a href="{{ route('user.listing-schedule.index', $listingId) }}" class="btn btn-primary"><i
                                    class="fas fa-chevron-left"></i></a>
                            <h4>Create Schedule</h4>

                            <form action="{{ route('user.listing-schedule.store', $listingId) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <button type="submit" class="read_btn submit-button mt-4">Create</button>
                                </div>
