                        ...
                        <div class="form-group">
                            ...
                            <select name="stripe_country" class="form-control select2">
                                ...
                                @foreach (config('countries') as $key => $country)
                                    <option @selected($key === config('payment.stripe_country')) value="{{ $key }}">{{ $country }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <Select name="stripe_currency" class="form-control select2">
                                ...
                                @foreach (config('currencies.currency_list') as $key => $currency)
                                    <option @selected($currency == config('payment.stripe_currency')) value="{{ $currency }}">{{ $key }}
                                        ({{ $currency }})</option>
                                @endforeach
                            </Select>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="stripe_key"
                                value="{{ config('payment.stripe_key') }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
